...
<nav class="breadcrumb">
    <div class="container"><i class="Hui-iconfont">&#xe67f;</i> <a href="/" class="c-primary">首页</a> <span
            class="c-gray en">&gt;</span> <a href="#">组件</a> <span class="c-gray en">&gt;</span> <span class="c-gray">当前页面</span>
    </div>
</nav>
<section class="container">
        ...
        <div class="panel-body">
            <form action="" method="post" class="form form-horizontal responsive" id="demoform">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8">
                        <input type="text" class="input-text" autocomplete="off" placeholder="手机" name="telephone"
                               id="telephone">
                    </div>
                </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8">
                        <input type="password" class="input-text" autocomplete="off" placeholder="密码" name="password2"
                               id="password2">
                    </div>
                </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8">
                        <input type="text" class="input-text" value="" autocomplete="off" id="datetimepicker"
                               name="datetimepicker">
                    </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls skin-minimal col-xs-5">
                        <div class="check-box">
                            <input type="checkbox" id="checkbox-5" name="checkbox2" datatype="*">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls skin-minimal col-xs-5">
                        <div id="spinner-demo" class="spinner"></div>
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-3">附件：</label>
                    <div class="formControls col-xs-8"> <span class="btn-upload form-group">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8">
                        <input type="text" class="input-text" placeholder="http://" name="website" id="website"
                               datatype="url" nullmsg="网址不能为空">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-3">备注：</label>
                    <div class="formControls col-xs-8">
                        <textarea cols="" rows="" class="textarea" name="beizhu" id="beizhu"
                                  placeholder="说点什么...最少输入10个字符" onkeyup="$.Huitextarealength(this,500)"></textarea>
    ...
    <div class="panel panel-default mt-20">
        ...
        <div class="panel-body">
            <table class="table table-border table-bordered table-striped mt-20">
                ...
                <tr>
                    <td>
                        <button class="btn btn-default radius" type="button">默认</button>
                    </td>
                ...
                <tr>
                    <td>
                        <button class="btn btn-primary radius" type="button">主要</button>
                    </td>
                ...
                <tr>
                    <td>
                        <button class="btn btn-secondary radius" type="button">次要</button>
                    </td>
                ...
                <tr>
                    <td>
                        <button class="btn btn-success radius" type="button">成功</button>
                    </td>
                ...
                <tr>
                    <td>
                        <button class="btn btn-warning radius" type="button">警告</button>
                    </td>
                ...
                <tr>
                    <td>
                        <button class="btn btn-danger radius" type="button">危险</button>
                    </td>
                ...
                <tr>
                    <td>
                        <button class="btn btn-link radius" type="button">链接</button>
                    </td>
            ...
            <h3>按钮组</h3>
            <div class="btn-group"><span class="btn btn-primary radius">左边按钮</span> <span
                    class="btn btn-default radius">中间按钮</span> <span class="btn btn-default radius">中间按钮</span> <span
                    class="btn btn-default radius">右边按钮</span></div>
            <div class="cl mt-20">
                <div class="btn-group l"><span class="btn btn-primary" title="源代码"><i class="Hui-iconfont">&#xe6ee;</i></span>
                </div>
                <div class="btn-group l ml-5"><span class="btn btn-primary" title="左对齐"><i
                        class="Hui-iconfont">&#xe710;</i></span> <span class="btn btn-primary" title="居中对齐"><i
                        class="Hui-iconfont">&#xe70e;</i></span> <span class="btn btn-primary" title="右对齐"><i
                        class="Hui-iconfont">&#xe711;</i></span> <span class="btn btn-primary" title="两头对齐"><i
                        class="Hui-iconfont">&#xe70f;</i></span></div>
                <div class="btn-group l ml-5"><span class="btn btn-primary" title="字体"><i
                        class="Hui-iconfont">&#xe6ec;</i></span> <span class="btn btn-primary" title="加粗"><i
                        class="Hui-iconfont">&#xe6e7;</i></span> <span class="btn btn-primary" title="倾斜"><i
                        class="Hui-iconfont">&#xe6e9;</i></span> <span class="btn btn-primary" title="下划线"><i
                        class="Hui-iconfont">&#xe6fe;</i></span> <span class="btn btn-primary" title="行高"><i
                        class="Hui-iconfont">&#xe6fc;</i></span> <span class="btn btn-primary" title="行宽"><i
                        class="Hui-iconfont">&#xe6fd;</i></span></div>
                <div class="btn-group l ml-5"><span class="btn btn-primary" title="链接"><i
                        class="Hui-iconfont">&#xe6f1;</i></span> <span class="btn btn-primary" title="有序列表"><i
                        class="Hui-iconfont">&#xe6f3;</i></span> <span class="btn btn-primary" title="无序列表"><i
                        class="Hui-iconfont">&#xe6f5;</i></span></div>
                <div class="btn-group l ml-5"><span class="btn btn-primary" title="剪切"><i
                        class="Hui-iconfont">&#xe6ef;</i></span> <span class="btn btn-primary" title="复制"><i
                        class="Hui-iconfont">&#xe6ea;</i></span> <span class="btn btn-primary" title="粘贴"><i
                        class="Hui-iconfont">&#xe6eb;</i></span></div>
            </div>
        </div>
    </div>
    <div class="panel panel-default mt-20">
        ...
        <div class="panel-body">
            <p><img width="140" height="140"
                    ...
                    alt="..." class="radius"> <img width="140" height="140"
                                                   src="data:image/svg+xml;base64,"
                                                   alt="..." class="round"> <img style="width:140px; height:140px"
                                                                                 src="data:image/svg+xml;base64,"
            ...
            <div><img src="http://static.h-ui.net/h-ui/images/ucnter/avatar-default.jpg"
                      class="avatar radius size-MINI"> <img
                    src="http://static.h-ui.net/h-ui/images/ucnter/avatar-default.jpg" class="avatar radius size-S">
                <img src="http://static.h-ui.net/h-ui/images/ucnter/avatar-default.jpg" class="avatar radius size-M">
                <img src="http://static.h-ui.net/h-ui/images/ucnter/avatar-default.jpg" class="avatar radius size-L">
                <img src="http://static.h-ui.net/h-ui/images/ucnter/avatar-default.jpg" class="avatar radius size-XL">
            </div>
            <div class="maskWraper" style="width:300px; height:250px; border:solid 1px #ddd;"><img
                    src="http://images.h-ui.net/www/AD-300x250.gif" width="300" height="250">
    ...
    <div class="panel panel-default mt-20">
        ...
        <div class="panel-body">
            <div class="progress radius">
                <div class="progress-bar"><span class="sr-only" style="width:25%"></span></div>
            </div>
        </div>
    </div>
    <div class="panel panel-default mt-20">
    ...
    <div class="panel panel-default mt-20">
        ...
        <div class="panel-body">
            <section class="share cl">
                <div class="bdsharebuttonbox Hui-share"><span class="share-text Hui-iconfont">&#xe715;</span> <a
                        href="#" class="bds_weixin Hui-iconfont" data-cmd="weixin" title="分享到微信">&#xe694;</a> <a
                        href="#" class="bds_qzone Hui-iconfont" data-cmd="qzone" title="分享到QQ空间">&#xe6c8;</a> <a
                        href="#" class="bds_sqq Hui-iconfont" data-cmd="sqq" title="分享到QQ好友">&#xe67b;</a> <a href="#"
                                                                                                             class="bds_tsina Hui-iconfont"
                                                                                                             data-cmd="tsina"
                                                                                                             title="分享到新浪微博">
                    &#xe6da;</a> <a href="#" class="bds_tqq Hui-iconfont" data-cmd="tqq" title="分享到腾讯微博">&#xe6d9;</a> <a
                        href="#" class="bds_douban Hui-iconfont" data-cmd="douban" title="分享到豆瓣网">&#xe67c;</a></div>
    ...
    <div class="panel panel-default mt-20">
        ...
        <div class="panel-body">
            <div class="clearfix"><span class="f-l f-15 va-m">描述相符：</span>
                <div id="star-1" class="star-bar size-M f-l mr-10 va-m"></div>
                <strong id="result-1" class="f-l va-m"></strong></div>
        </div>
    </div>
    <div class="panel panel-default mt-20">
        <div class="panel-header">tooltip效果</div>
        <div class="panel-body">
            <button class="btn btn-primary radius" data-toggle="tooltip" data-placement="right" title="右边显示">右边显示
            </button>
            <button class="btn btn-primary radius" data-toggle="tooltip" data-placement="top" title="上边显示">上边显示</button>
            <button class="btn btn-primary radius" data-toggle="tooltip" data-placement="bottom" title="下边显示">下边显示
            </button>
            <button class="btn btn-primary radius" data-toggle="tooltip" data-placement="left" title="左边显示">左边显示
            </button>
        </div>
    </div>
    <div class="panel panel-default mt-20">
        ...
        <div class="panel-body">
            <button type="button" class="btn btn-primary radius" title="标题" data-container="body" data-toggle="popover"
                    data-placement="left" data-content="左侧的 Popover 中的一些内容">左侧的 Popover
            </button>
            <button type="button" class="btn btn-primary radius" title="标题" data-container="body" data-toggle="popover"
                    data-placement="top" data-content="顶部的 Popover 中的一些内容">顶部的 Popover
            </button>
            <button type="button" class="btn btn-primary radius" title="标题" data-container="body" data-toggle="popover"
                    data-placement="bottom" data-content="底部的 Popover 中的一些内容">底部的 Popover
            </button>
            <button type="button" class="btn btn-primary radius" title="标题" data-container="body" data-toggle="popover"
                    data-placement="right" data-content="右侧的 Popover 中的一些内容">右侧的 Popover
            </button>
        </div>
    </div>
    <div class="panel panel-default mt-20">
        <div class="panel-header clearfix"><span class="f-l">H-ui.js v3.0 整合的第三方插件<small>(引入了H-ui.js v3.0版本，无需再单独重复引用以下插件)</small></span>
            <span class="f-r">感谢以下插件！优秀的插件就像金子一样，处处发光</span></div>
        <div class="panel-body">
            <table class="table table-border table-bordered table-bg">
                <thead>
                <tr>
                ...
                <tbody>
                <tr>
                    <td><a href="http://www.h-ui.net/lib/jquery.cookie.js.shtml" target="_blank">jQuery.cookie.js</a>
                    </td>
                    <td>1.4.1</td>
                    <td>jQuery cookie插件。</td>
                </tr>
                <tr>
                    <td>jQuery.form.js</td>
                    <td>3.51.0</td>
                    <td>jquey表单插件。</td>
                </tr>
                <tr>
                    <td><a href="http://www.h-ui.net/lib/jquery.lazyload.js.shtml"
                           target="_blank">jQuery.lazyload.js</a></td>
                    <td>1.9.3</td>
                    <td>图片的延迟加载插件。</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>jQuery.togglePassword.js</td>
                    <td></td>
                    <td>密码框显示隐藏密码插件。</td>
                </tr>
                <tr>
    ...
    <div class="panel panel-default mt-20">
        <div class="panel-header clearfix"><span class="f-l">lib中的第三方插件</span> <span class="f-r">非必选插件，请有选择性的使用，用不上的可自行删除，减少框架体积</span>
        </div>
        <div class="panel-body">
            <table class="table table-border table-bordered table-bg">
                <thead>
...
<footer class="footer mt-20">
    <div class="container">
        <nav class="footer-nav"><a target="_blank" href="http://www.h-ui.net/aboutHui.shtml">关于H-ui</a> <span
                class="pipe">|</span> <a target="_blank" href="http://www.h-ui.net/copyright.shtml">软件著作权</a> <span
                class="pipe">|</span> <a target="_blank" href="http://www.h-ui.net/juanzeng.shtml">感谢捐赠</a></nav>
